...
const Introduction =(props) => {
    return (
        <div style={{height:'90vh', width:'50%', padding:'50px', backgroundColor:'#000000',fontFamily:'monospace',fontSize:'25px',color:'#FFFFFF'}}>
            {props.retrieved && <Results topicWords={props.topicWords} correlations={props.correlations}></Results>}
            ...
            {!props.retrieved && <img src="lda.png" alt="algorithm" style={{padding:"50px 2px",height:"45vh",width:"90vh"}}></img>}
        </div>
    );
}
